...
export function LoginForm({
  ...
  return (
    <div className={cn("flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-4", className)} {...props}>
        ...
        <Card className="border-0 shadow-xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              {error && (
                <Alert variant="destructive" className="animate-in fade-in-0 slide-in-from-left-2">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  {emailError && (
                    <p className="text-sm text-red-600 dark:text-red-400 animate-in fade-in-0 slide-in-from-left-2">
                      {emailError}
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <a
                      href="#"
                      className="text-sm text-blue-600 hover:text-blue-500 hover:underline underline-offset-4 transition-colors"
                    >
                      Forgot password?
                    </a>
                  </div>
              ...
              <div className="space-y-4">
                <Button 
                  type="submit" 
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-3 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
